...
# 회귀는 연속된 값을 정확히 예측하는 것이 목적.
# 선형회귀 (Linear Regression)는 데이터의 경향성을 가장 잘 설명하는 하나의 직선을 예측하는 것.

# 아래의 예시는 최소제곱법(Least Square Method)을 사용한 프로그램이다.
# 최소제곱법이란, 예측직선 과 데이터의 차이인 잔차(Residual)의 제곱을 최소화하는 알고리즘이다.
